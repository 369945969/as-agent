...
public class Config {
    ...
    public final String modelConfigFile;
    ...
    public Config() {
        ...
        this.modelConfigFile = env("DSH_MODEL_CONFIG",
                System.getProperty("user.home") + "/.dsh/model-config.json");
        this.dbFile = env("DSH_DB", ".agentscope/agentscope.db");
